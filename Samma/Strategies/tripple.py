...
class Tripple:
    def __init__(self, events, bars, args, symbol_list=None):
        ...
        self.bars = bars
       # print("ARGS: ",args)
       # print("MINA: ",events, bars, symbol_list)
        if symbol_list == None:
       ...
       # print(self.symbol_list)
        ...
        self.middle_window = int(args[0][0][1])
        self.short_window = int(args[0][0][2])
       # print(self.long_window, self.middle_window, self.short_window)
